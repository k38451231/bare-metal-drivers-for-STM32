...
void SPI2_GPIOInits(void){
	...
	// in this exercise we don't have slave, so skip MISO, NSS configurations
...
void SPI1_Inits(void)
{
	...
	SPI1Handle.SPIConfig.SPI_SclkSpeed = SPI_SCLK_SPEED_DIV2; // Serial clock of 8M Hz
	SPI1Handle.SPIConfig.SPI_DFF = SPI_DFF_8BITS;
	SPI1Handle.SPIConfig.SPI_CPOL = SPI_CPOL_LOW;
	SPI1Handle.SPIConfig.SPI_CPHA = SPI_CPHA_LOW;
	SPI1Handle.SPIConfig.SPI_SSM = SPI_SSM_EN; //software slave management enable for NSS pin
