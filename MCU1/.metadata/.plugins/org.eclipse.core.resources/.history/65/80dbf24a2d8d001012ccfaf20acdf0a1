...
// peripheral register definition structure for SPI (refer to SPI register map)
typedef struct
{
	__vo uint32_t CR1;
	__vo uint32_t CR2;
...
// peripheral register definition structure for I2C (refer to I2C register map)
typedef struct
{
	__vo uint32_t CR1;
	__vo uint32_t CR2;
